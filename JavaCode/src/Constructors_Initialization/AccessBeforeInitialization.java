...
public class AccessBeforeInitialization {
	public static void main(String[] args) {
		 ...
		 * re-entered. Baz.test is then called from Bar "Test done i = 0"
		 * is printed since i is uninitialized. The initialization of Bar 
		 * is then flagged as complete. Baz initialization resumes "In Baz 
		 * init i=0" is printed then i is set to 123. Initialization of Baz
		 * is flagged as complete and Baz.test from Foo is run.
		 * "Test done i = 123" is printed.
		 */
		Baz.test();
	}
