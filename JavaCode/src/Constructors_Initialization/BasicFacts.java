...
public class BasicFacts {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 2) Allocate memory for fields of A, B and Object and initialises with default values.
		 ...
		 * the same object reference.
		 * 
		 * 6) constructor of 'Object' completes its work and returns the updated object
		 * reference constructor B where it left, constructor of B also updates the fields
		 * through this object reference and then passes to constructor of A.
		 * 
		 * 7) This updated object reference is returned to caller of new A();
		 * 
		 * 
		 */
