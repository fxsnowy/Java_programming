 ...
 * 
 * Where did the extra bytes come from, and what is their significance? 
 * They are introduced by the serialization algorithm, and are required 
 * in order to to re-create the object.
 * 
 * 
 */ 
